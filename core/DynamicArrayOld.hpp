...
public:
    ...
    explicit DynamicArrayOld(const Allocator& alloc)
        : m_alloc(alloc) { }
    DynamicArrayOld(size_type size, const Allocator& alloc = Allocator())
        : m_alloc(alloc)
        , m_first(nullptr)
        , m_last(nullptr)
        , m_capacity(nullptr) {
    ...
    DynamicArrayOld(const DynamicArrayOld& other, const Allocator& alloc)
        : DynamicArrayOld(other.begin(), other.end(), alloc) { }
    ...
    DynamicArrayOld(DynamicArrayOld&& other, const Allocator& alloc)
        : m_alloc(alloc)
        , m_first(nullptr)
        , m_last(nullptr)
        , m_capacity(nullptr) {
    ...
    DynamicArrayOld(
        ...
        : DynamicArrayOld(il.begin(), il.end(), alloc) { }

    template <class It>
    DynamicArrayOld(It first, It last, const Allocator& alloc = Allocator())
        : m_alloc(alloc)
        , m_first(nullptr)
        , m_last(nullptr)
        , m_capacity(nullptr) {
    ...
    DynamicArrayOld& operator=(DynamicArrayOld&& other) { }
...
private:
    ...
    static void s_swap(DynamicArrayOld& a, DynamicArrayOld& b) noexcept {
